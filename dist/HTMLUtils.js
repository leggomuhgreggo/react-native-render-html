...
const TextOnlyPropTypes = TextStylePropTypes.filter(prop => ViewStylePropTypes.indexOf(prop) === -1); // These tags should ALWAYS be mapped to View wrappers

exports.TextOnlyPropTypes = TextOnlyPropTypes;
const BLOCK_TAGS = ['address', 'article', 'aside', 'footer', 'hgroup', 'nav', 'section', 'blockquote', 'dd', 'dl', 'dt', 'figure', 'hr', 'li', 'main', 'ol', 'ul', 'cite', 'data', 'rp', 'rtc', 'ruby', 'area', 'img', 'map', 'center']; // These tags should ALWAYS be mapped to Text wrappers

exports.BLOCK_TAGS = BLOCK_TAGS;
const TEXT_TAGS = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'figcaption', 'p', 'pre', 'abbr', 'b', 'bdi', 'bdo', 'code', 'dfn', 'i', 'kbd', 'mark', 'q', 'rt', 's', 'samp', 'small', 'big', 'span', 'strong', 'sub', 'sup', 'time', 'u', 'var', 'wbr', 'del', 'ins', 'blink', 'font', 'em', 'bold', 'br']; // Text in these tags should not be stripped from line breaks

exports.TEXT_TAGS = TEXT_TAGS;
const PREFORMATTED_TAGS = ['pre']; // These tags can either be mapped to View or Text wrappers, depending solely on their children

exports.PREFORMATTED_TAGS = PREFORMATTED_TAGS;
const MIXED_TAGS = ['a']; // These text tags shouldn't be associated with their siblings in the associateRawTags method

exports.MIXED_TAGS = MIXED_TAGS;
const TEXT_TAGS_IGNORING_ASSOCIATION = ['p', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6'];
exports.TEXT_TAGS_IGNORING_ASSOCIATION = TEXT_TAGS_IGNORING_ASSOCIATION;
const ABSOLUTE_FONT_SIZE = {
  'medium': 14,
  'xx-small': 8.5,
  'x-small': 10,
  'small': 12,
...
const PERC_SUPPORTED_STYLES = ['width', 'height', 'top', 'bottom', 'left', 'right', 'margin', 'marginBottom', 'marginTop', 'marginLeft', 'marginRight', 'marginHorizontal', 'marginVertical', 'padding', 'paddingBottom', 'paddingTop', 'paddingLeft', 'paddingRight', 'paddingHorizontal', 'paddingVertical'];
