...
function () {
  ...
  DomHandler.prototype.ontext = function (data) {
    ...
    /* Text */
      ...
      var node$1 = new node.DataNode("text"
      /* Text */
      , data);
      this.addNode(node$1);
  ...
  DomHandler.prototype.oncomment = function (data) {
    ...
    var node$1 = new node.DataNode("comment"
    /* Comment */
    , data);
    this.addNode(node$1);
    this._lastNode = node$1;
  ...
  DomHandler.prototype.oncdatastart = function () {
    var text = new node.DataNode("text"
    /* Text */
    , "");
...
function formatAttrs(attributes, opts) {
  ...
  for (var key in attributes) {
    ...
    if (value !== null && value !== '' || opts.xmlMode) {
      output += '="' + (opts.decodeEntities ? lib$2.encodeXML(value) : value.replace(/\"/g, '&quot;')) + '"';
    }
  }
...
var render = module.exports = function (dom, opts) {
  ...
  for (var i = 0; i < dom.length; i++) {
    var elem = dom[i];
    if (elem.type === 'root') output += render(elem.children, opts);else if (lib$1.isTag(elem)) output += renderTag(elem, opts);else if (elem.type === lib$1.Directive) output += renderDirective(elem);else if (elem.type === lib$1.Comment) output += renderComment(elem);else if (elem.type === lib$1.CDATA) output += renderCdata(elem);else output += renderText(elem, opts);
  }
...
function existsOne(test, elems) {
  for (var i = 0; i < elems.length; i++) {
    ...
    if (tagtypes.isTag(checked) && (test(checked) || checked.children.length > 0 && existsOne(test, checked.children))) {
      return true;
    }
  }
...
function findAll(test, rootElems) {
  ...
  while (stack.length) {
    ...
    if (!elem || !tagtypes.isTag(elem)) continue;
...
exports.DefaultHandler = lib.DomHandler; // Helper methods
...
function (_PureComponent) {
  ...
  function HTMLImage(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(HTMLImage).call(this, props));
    _this.state = {
  ...
  createClass(HTMLImage, [{
    ...
    value: function validImage(source, style) {
      ...
      return React__default.createElement(reactNative.Image, _extends_1({
        source: source,
        style: [style, {
...
defineProperty(HTMLImage, "propTypes", {
...
defineProperty(HTMLImage, "defaultProps", {
...
function a(htmlAttribs, children, convertedCSSStyles, passProps) {
  ...
  if (parentWrapper === 'Text') {
    return React__default.createElement(reactNative.Text, _extends_1({}, passProps, {
      style: style,
      onPress: onPress,
      key: key
    }), children || data);
...
function img(htmlAttribs, children, convertedCSSStyles) {
  ...
  return React__default.createElement(HTMLImage, _extends_1({
    source: {
      uri: src
    },
    alt: alt,
...
function ul(htmlAttribs, children, convertedCSSStyles) {
  ...
  children = children && children.map(function (child, index) {
    ...
    var prefix = false;
    var rendererArgs = [htmlAttribs, children, convertedCSSStyles, _objectSpread$1({}, passProps, {
      index: index
    })];
...
function (_PureComponent) {
  ...
  function HTML(props) {
    ...
    _this = possibleConstructorReturn(this, getPrototypeOf(HTML).call(this, props));
    _this.state = {};
    _this.renderers = _objectSpread$2({}, HTMLRenderers, {}, _this.props.renderers || {});
    return _this;
  }
  ...
  createClass(HTML, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if (renderers !== nextProps.renderers) {
        this.renderers = _objectSpread$2({}, HTMLRenderers, {}, nextProps.renderers || {});
      }
    ...
    value: function registerDOM() {
      var props,
          ...
          response,
          _args = arguments;
      return regenerator.async(function registerDOM$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              _context.next = 13;
              return regenerator.awrap(fetch(uri));
      ...
      .map(function (parsedNode, nodeIndex) {
        ...
        if (firstChild && children.length === 1) {
          ...
          if ((attribs === firstChild.attribs || !firstChild.attribs) && firstChild.wrapper === wrapper && (tagName === firstChild.tagName || firstChild.tagName === 'rawtext')) {
            ...
            return _objectSpread$2({}, parsedNode, {
              attribs: _objectSpread$2({}, attribs, {}, firstChild.attribs),
        ...
        if (wrapper === 'View' && attribs && _this3.wrapperHasTextChild(children)) {
          ...
          var wrapperStyles = _objectSpread$2({}, tagsStyles[tagName] || {}, {}, _getElementClassStyles(attribs, classesStyles), {}, cssStringToObject(attribs.style || ''));
          ...
          for (var i = 0; i < children.length; i++) {
            ...
            if (_wrapper === 'Text') {
              ...
              if (!_attribs.style) {
                ...
                child.attribs.style = cssObjectToString(_objectSpread$2({}, textChildrenInheritedStyles, {}, cssStringToObject(child.attribs.style)));
              }
            }
          }
        }
    ...
    value: function renderRNElements(RNElements) {
      ...
      return RNElements && RNElements.length ? RNElements.map(function (element, index) {
        ...
        if (_this4.renderers[tagName]) {
          ...
          return customRenderer(attribs, childElements, convertedCSSStyles, _objectSpread$2({}, props, {
...
defineProperty(HTML, "defaultProps", {
